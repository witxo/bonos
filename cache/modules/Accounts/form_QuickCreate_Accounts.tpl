...
{/if}  
<input type='text' name='{$fields.cif_c.name}' 
id='{$fields.cif_c.name}' size='30' 
maxlength='9' 
value='{$value}' title=''      >
...
{/if}  
<input type='text' name='{$fields.alumno_c.name}' 
id='{$fields.alumno_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
...
addToValidate('form_QuickCreate_Accounts', 'pen_firmado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_PEN_FIRMADO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'nca_escaneado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_NCA_ESCANEADO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'pen_entregado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_PEN_ENTREGADO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'alumno_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ALUMNO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'ncp_firmado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_NCP_FIRMADO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'ncp_entregado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_NCP_ENTREGADO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'curso_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CURSO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'blog_entregado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_BLOG_ENTREGADO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'asignaturas_c', 'text', false,'{/literal}{sugar_translate label='LBL_ASIGNATURAS' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'nuc_firmado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_NUC_FIRMADO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'nuc_escaneado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_NUC_ESCANEADO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'prev_firmado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_PREV_FIRMADO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'nca_firmado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_NCA_FIRMADO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'blog_escaneado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_BLOG_ESCANEADO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'blog_firmado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_BLOG_FIRMADO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'descripcion_recibo_c', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPCION_RECIBO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'pen_escaneado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_PEN_ESCANEADO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'nuc_entregado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_NUC_ENTREGADO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'cantidad_recibo_c', 'currency', false,'{/literal}{sugar_translate label='LBL_CANTIDAD_RECIBO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'grupo_c', 'enum', true,'{/literal}{sugar_translate label='LBL_GRUPO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'colegio_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_COLEGIO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'prev_escaneado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_PREV_ESCANEADO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'recibosino_c', 'enum', true,'{/literal}{sugar_translate label='LBL_RECIBOSINO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'cif_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CIF' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'numero_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_NUMERO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'nca_entregado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_NCA_ENTREGADO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'ncp_escaneado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_NCP_ESCANEADO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'prev_entregado_c', 'bool', false,'{/literal}{sugar_translate label='LBL_PREV_ENTREGADO' module='Accounts' for_js=true}{literal}' );
