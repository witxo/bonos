...
{html_options id='account_type_advanced' name='account_type_advanced[]' options=$fields.account_type_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.account_type_advanced.value}
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='grupo_c_advanced'>{sugar_translate label='LBL_GRUPO' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{html_options id='grupo_c_advanced' name='grupo_c_advanced[]' options=$fields.grupo_c_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.grupo_c_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='alumno_c_advanced'>{sugar_translate label='LBL_ALUMNO' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{if strlen($fields.alumno_c_advanced.value) <= 0}
{assign var="value" value=$fields.alumno_c_advanced.default_value }
{else}
{assign var="value" value=$fields.alumno_c_advanced.value }
{/if}  
<input type='text' name='{$fields.alumno_c_advanced.name}' 
    id='{$fields.alumno_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
   	   	</td>
	</tr>
