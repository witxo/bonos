...
4) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
  ...
  'LBL_FACT_CONFIG_GROUP' => 'Regoluna Invoices',
  'LBL_FACT_CONFIG_GROUP_DESC' => 'Configure invoices.',
  'LBL_FACT_CONFIG' => 'Invoice config',
  'LBL_FACT_CONFIG_DESC' => 'Opciones de numeración y generación de facturas PDF y Facturae',
  'LBL_FACT_CHECK' => 'System check',
  'LBL_FACT_CHECK_DESC' => 'Check dependencies and configuration',
  'LBL_CHECKING_GD' => 'Checking GD ...',
  'LBL_GD_INSTALLED' => 'It looks like GD is installed',
  'LBL_GD_NOT_INSTALLED' => 'It looks like GD extension for PHP is not installed.<br>GD is needed to generate invoice PDFs',
  'LBL_CHECKING_CRYPTOAPPLET' => 'Checking CryptoApplet ...',
  'LBL_CRYPTOAPPLET_INSTALLED' => 'It looks like CryptoApplet is correctly installed',
  'LBL_CRYPTOAPPLET_NOT_INSTALLED' => 'CryptoApplet is not installed.<br>CryptoApplet is needed to sign invoices',
  'LBL_CRYPTOAPPLET_ACTIVATED' => 'Electronic signature has been activated.',
  'LBL_CRYPTOAPPLET_DEACTIVATED' => 'Electronic signature has been deactivated.',
);