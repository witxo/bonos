...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Bonos_Bonos'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Bonos_Bonos'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Bonos_Bonos'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Bonos_Bonos'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['numerobono']['name']; ?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['precio']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PRECIO','module' => 'Bonos_Bonos'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['precio']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['precio']['name']; ?>
">
<?php echo smarty_function_sugar_number_format(array('var' => $this->_tpl_vars['fields']['precio']['value'],'precision' => 2), $this);?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['fechacaducidad']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_FECHACADUCIDAD','module' => 'Bonos_Bonos'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['fechacaducidad']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (strlen ( $this->_tpl_vars['fields']['fechacaducidad']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['fechacaducidad']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['fechacaducidad']['value']);  endif; ?>
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['fechacaducidad']['name']; ?>
"><?php echo $this->_tpl_vars['value']; ?>
</span>
<?php endif; ?>
</td>
...
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['inactivo']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<input type="checkbox" class="checkbox" name="<?php echo $this->_tpl_vars['fields']['inactivo']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['inactivo']['name']; ?>
" value="$fields.inactivo.value" disabled="true" <?php echo $this->_tpl_vars['checked']; ?>
>
<?php endif; ?>
</td>
</tr>
