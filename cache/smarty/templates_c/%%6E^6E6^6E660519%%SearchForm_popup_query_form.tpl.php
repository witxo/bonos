...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='grupo_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_GRUPO','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php echo smarty_function_html_options(array('id' => 'grupo_c_advanced','name' => 'grupo_c_advanced[]','options' => $this->_tpl_vars['fields']['grupo_c_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['grupo_c_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='alumno_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ALUMNO','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['alumno_c_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['alumno_c_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['alumno_c_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['alumno_c_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['alumno_c_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
