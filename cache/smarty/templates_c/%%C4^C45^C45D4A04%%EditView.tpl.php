<?php /* Smarty version 2.6.11, created on 2017-05-30 13:30:09
         compiled from cache/modules/Bonos_Bonos/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/modules/Bonos_Bonos/EditView.tpl', 38, false),array('modifier', 'strip_semicolon', 'cache/modules/Bonos_Bonos/EditView.tpl', 57, false),array('modifier', 'default', 'cache/modules/Bonos_Bonos/EditView.tpl', 153, false),array('function', 'sugar_include', 'cache/modules/Bonos_Bonos/EditView.tpl', 44, false),array('function', 'counter', 'cache/modules/Bonos_Bonos/EditView.tpl', 50, false),array('function', 'sugar_translate', 'cache/modules/Bonos_Bonos/EditView.tpl', 56, false),array('function', 'sugar_number_format', 'cache/modules/Bonos_Bonos/EditView.tpl', 100, false),array('function', 'sugar_getimage', 'cache/modules/Bonos_Bonos/EditView.tpl', 142, false),array('function', 'sugar_getimagepath', 'cache/modules/Bonos_Bonos/EditView.tpl', 210, false),)), $this); ?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='bonos_bonos_accounts_name_label' width='12.5%' scope="col">
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['bonos_bonos_accounts_name']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['bonos_bonos_accounts_name']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['bonos_bonos_accounts_name']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['bonos_bonos_accounts_name']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['bonos_bonos_accounts_name']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['bonos_bonos_accountsaccounts_ida']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['bonos_bonos_accounts_name']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['bonos_bonos_accounts_name']['name']; ?>
...
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['bonos_bonos_accounts_name']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"bonos_bonos_accountsaccounts_ida","name":"bonos_bonos_accounts_name"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['bonos_bonos_accounts_name']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['bonos_bonos_accounts_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['bonos_bonos_accounts_name']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['bonos_bonos_accounts_name']['id_name']; ?>
...
_<?php echo $this->_tpl_vars['fields']['bonos_bonos_accounts_name']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
addToValidate(\'EditView\', \'numerobono\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NUMEROBONO','module' => 'Bonos_Bonos','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'bonos_bonos_accounts_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_BONOS_BONOS_ACCOUNTS_FROM_ACCOUNTS_TITLE','module' => 'Bonos_Bonos','for_js' => true), $this); echo '\' );
...
addToValidateBinaryDependency(\'EditView\', \'bonos_bonos_accounts_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Bonos_Bonos','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_BONOS_BONOS_ACCOUNTS_FROM_ACCOUNTS_TITLE','module' => 'Bonos_Bonos','for_js' => true), $this); echo '\', \'bonos_bonos_accountsaccounts_ida\' );
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'EditView_bonos_bonos_accounts_name\']={"form":"EditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["EditView_bonos_bonos_accounts_name","bonos_bonos_accountsaccounts_ida"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["bonos_bonos_accountsaccounts_ida"],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};</script>'; ?>
