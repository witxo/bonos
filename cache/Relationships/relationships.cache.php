 ...
 $relationships = array (
  ...
  array (
    ...
    array (
      ...
      3 => 
      array (
        'name' => 'meetings_accounts_2meetings_ida',
        'type' => 'varchar',
        'len' => 36,
      ),
      4 => 
      array (
        'name' => 'meetings_accounts_2accounts_idb',
        'type' => 'varchar',
        'len' => 36,
      ),
    ),
    ...
    array (
      ...
      1 => 
      array (
        'name' => 'meetings_accounts_2_alt',
        'type' => 'alternate_key',
        'fields' => 
        array (
          0 => 'meetings_accounts_2meetings_ida',
          1 => 'meetings_accounts_2accounts_idb',
        ),
      ),
    ),
    'lhs_module' => 'Meetings',
  ...
  array (
    'name' => 'preci_precios_modified_user',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
  ...
  array (
    'name' => 'preci_precios_assigned_user',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
    'rhs_module' => 'preci_Precios',
  ...
  array (
    'name' => 'con_contratos_modified_user',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
    'rhs_module' => 'CON_Contratos',
  ...
  array (
    'name' => 'con_contratos_assigned_user',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
    'rhs_module' => 'CON_Contratos',
  ...
  array (
    'name' => 'fact_facturas_modified_user',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
    'rhs_module' => 'fact_Facturas',
  ...
  array (
    'name' => 'fact_facturas_assigned_user',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
    'rhs_module' => 'fact_Facturas',
  ...
  array (
    'name' => 'bonos_bonos_modified_user',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
    'rhs_module' => 'Bonos_Bonos',
  ...
  array (
    'name' => 'bonos_bonos_assigned_user',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
    'rhs_module' => 'Bonos_Bonos',
