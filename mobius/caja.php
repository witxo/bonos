...
if ($ini == '1' and $actualizar == 'Actualizar')
{
	...
	$consulta3 = mysql_insert_array('movimientos_caja_mobius', $mov_caja);
	$resultado = mysql_query($consulta3);		
 
 
     $consulta = "Select * from caja_mobius where fecha ='".date("Y-m-d")."'";
...
//        $consulta = "Select * from caja_mobius where fecha ='".date("Y-m-d", strtotime("yesterday"))."'";
        $consulta = "Select * from caja_mobius where fecha <'".date("Y-m-d")."'"." order by fecha desc";
        $resultado = mysql_query($consulta, $conexion);
	    ...
	    $consulta3 = mysql_insert_array('caja_mobius', $caja);
     //echo $consulta3;
	    $resultado = mysql_query($consulta3);
     }
     else
     ...
     //echo $caja['cantidad'];
        $consulta = "delete from caja_mobius where fecha ='".date("Y-m-d")."'";
...
{
    $consulta = "Select * from movimientos_caja_mobius where fecha ='".date("Y-m-d")."'";
